...
namespace Framework.Pages
{
    ...
    public sealed partial class CustomerCreate : SaveablePage
    {
        ...
        protected override void BindModel(object modelData)
        {
            ...
            if (MyViewModel.MyModel.BirthDate == Defaults.Date) MyViewModel.MyModel.BirthDate = DateTime.UtcNow.AddYears(-20);
        ...
        public override async Task<WorkerResult> Process()
        {
            ...
            modelData = await MyViewModel.CreateAsync(MyViewModel.MyModel);
            if (modelData.IsNew)
                returnValue.FailedRules.Add("1025", "Failed to create");
            else
                MyViewModel.MyModel = modelData;
