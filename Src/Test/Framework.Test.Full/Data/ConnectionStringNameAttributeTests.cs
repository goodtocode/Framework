...
{
    [TestClass()]
    public class FullConnectionStringNameTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Data_ConnectionStringFromConfig()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Data_ConnectionStringEntity()
        {
            var result = Defaults.String;
            var configManager =new ConfigurationManagerFull();
            var configConnectString = new ConnectionStringSafe();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Data_ConnectionStringDatabase()
        {
            var result = Defaults.String;
            var configManager =new ConfigurationManagerFull();
            var configConnectString = new ConnectionStringSafe();
