//-----------------------------------------------------------------------
// <copyright file="DataAccessBehaviorNameTests.cs" company="GoodToCode">
...
{
    [TestClass()]
    public class FullDataAccessBehaviorNameTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Data_DataAccessBehaviorAttribute()
        {
