...
{
    [TestClass()]
    public class FullStoredProcedureEntityTests
    {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_Save()
        {
            ...
            dbCustomer = reader.GetById(resultCustomer.Id);
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_Create()
        {
            var reader = new EntityReader<CustomerInfo>();
            var writer = new StoredProcedureWriter<CustomerInfo>();
            var newCustomer = new CustomerInfo();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_Read()
        {
            var db = new EntityReader<CustomerInfo>();
            var dbCustomer = new CustomerInfo();
            var lastKey = Defaults.Guid;

            Full_Entity_StoredProcedureEntity_Create();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_Update()
        {
            var db = new EntityReader<CustomerInfo>();
            var resultCustomer = new CustomerInfo();
            var dbCustomer = new CustomerInfo();
            ...
            resultCustomer = new StoredProcedureWriter<CustomerInfo>().Update(dbCustomer);
            Assert.IsTrue(resultCustomer.Id != Defaults.Integer);
            Assert.IsTrue(resultCustomer.Key != Defaults.Guid);
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_Delete()
        {
            var db = new EntityReader<CustomerInfo>();
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_GetById()
        {
        ...
        /// </summary>
        [TestMethod()]
        public void Full_Entity_StoredProcedureEntity_GetByKey()
        {
            var dbCustomer = new CustomerInfo();
            var dbReader = new EntityReader<CustomerInfo>();
            var lastKey = Defaults.Guid;
