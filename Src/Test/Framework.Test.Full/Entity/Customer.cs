...
namespace GoodToCode.Framework.Test
{
    ...
    /// </summary>
    [ConnectionStringName("DefaultConnection"), DatabaseSchemaName("Customer"), ColumnPrefix("Customer")]
    public partial class Customer : EntityInfo<Customer>
    {
        /// <summary>
        /// ValidationRules and BusinessRules that ensure no dirty data is committed
        /// </summary>
        public override IList<IValidationRule<Customer>> Rules()
        {
            return new List<IValidationRule<Customer>>()
            {
                new ValidationRule<Customer>(x => x.FirstName.Length > 0)
            };
        }
