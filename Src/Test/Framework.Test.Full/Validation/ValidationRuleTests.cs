//-----------------------------------------------------------------------
// <copyright file="ValidationRuleTests.cs" company="GoodToCode">
...
{
    [TestClass()]
    public class FullValidationRuleTests
    {
        [TestMethod()]
        public void Full_Validation_ValidationRule()
        {
        ...
        [TestMethod()]
        public void Full_Validation_Validate()
        {
            WorkerResult result = new WorkerResult() { ReturnId = 123 };
            ValidationRule<WorkerResult> rule = new ValidationRule<WorkerResult>(x => x.ReturnId > 0);
            Assert.IsTrue(rule.Validate(result) == true, "Did not work");
