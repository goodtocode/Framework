//-----------------------------------------------------------------------
// <copyright file="UniversalViewModel.cs" company="GoodToCode">
...
namespace GoodToCode.Framework.Application
{
    ...
    /// </summary>
    public class UniversalViewModel<TModel> : ViewModel<TModel>, ICrudOperationAsync<TModel>, INavigateType<TModel> where TModel : EntityModel<TModel>, new()
    {
        /// <summary>
