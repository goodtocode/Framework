//-----------------------------------------------------------------------
// <copyright file="ReadOnlyControl.cs" company="GoodToCode">
...
namespace GoodToCode.Framework.UserControls
{
    ...
    public abstract class ReadOnlyControl : UserControl
    {
        ...
        {
            var testControl = new TextBlock() { Text = textMessage };
            var rule = new ValidationRule<Control>(item => item.ActualHeight <= testControl.ActualHeight);
            return rule.IsValid;
        }
