...
namespace GoodToCode.Framework.Repository
{
    ...
    /// </summary>
    public class EntityWriter<TEntity> : DbContext, ISaveOperationAsync<TEntity>, ICreateOperationAsync<TEntity>, IUpdateOperationAsync<TEntity>, IDeleteOperationAsync<TEntity> where TEntity : EntityBase<TEntity>, new()
    {
        /// <summary>
