//-----------------------------------------------------------------------
// <copyright file="_Genesys_Help_Root_Tests.cs" company="Genesys Source">
...
{
    [TestClass()]
    public class Genesys_Help_Root_Tests
    {
        [TestMethod()]
        public async Task Genesys_Help_Root()
        {
            var configuration = ConfigurationManagerSafeTests.ConfigurationManagerSafeConstruct();
            var dataOut = TypeExtension.DefaultString;            
            var request = new HttpRequestGetString(configuration.AppSettingValue("GenesysHelpRoot"));
