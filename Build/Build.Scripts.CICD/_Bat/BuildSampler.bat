ECHO OFF
REM -----------------------------------------------------------------------
REM <copyright file="BuildSampler.bat" company="GoodToCode Source">
...
REM Execute
REM ***
ECHO Quick-Start Web App and Web Services
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe  -File ..\TryIt\Framework-Sampler-Web.ps1
