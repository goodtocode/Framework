ECHO OFF
REM -----------------------------------------------------------------------
REM <copyright file="BuildDocs.bat" company="GoodToCode Source">
...
REM Execute
REM ***
ECHO Docs - Reference Site
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Docs\Extensions-Docs.ps1
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Docs\Framework-Docs.ps1
