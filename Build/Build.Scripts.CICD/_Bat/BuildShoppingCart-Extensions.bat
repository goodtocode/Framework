ECHO OFF
REM -----------------------------------------------------------------------
REM <copyright file="BuildShoppingCart-Extensions.bat" company="GoodToCode Source">
...
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Shopping-Cart\Extensions-Shopping-Cart.ps1
