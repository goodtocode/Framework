ECHO OFF
REM -----------------------------------------------------------------------
REM <copyright file="BuildShoppingCart-Framework-for-All.bat" company="GoodToCode Source">
...
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Shopping-Cart\Framework-for-Universal-Shopping-Cart.ps1
