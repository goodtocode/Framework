...
REM ***
ECHO VSIX
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Vsix\Framework-Vsix-Mvc.ps1
...
%WINDIR%\SysWOW64\WindowsPowerShell\v1.0\Powershell.exe -File ..\Vsix\Framework-Vsix-Universal.ps1
