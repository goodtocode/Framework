#-----------------------------------------------------------------------
# <copyright file="Framework-for-WebAPI-Shopping-Cart.ps1" company="GoodToCode">
...
# ***
Copy-GoodToCodeSource -Path $BuildFull -RepoName $RepoName -ProductName $ProductName -SolutionFolder $SolutionFolder -Snk GoodToCode.snk
