#-----------------------------------------------------------------------
# <copyright file="Framework-for-MVC-Shopping-Cart.ps1" company="GoodToCode">
...
# ***
Copy-SourceCode -Path $BuildFull -RepoName $RepoName -ProductName $ProductName -SubFolder $SubFolder -SolutionFolder $SolutionFolder -Snk GoodToCode.snk
