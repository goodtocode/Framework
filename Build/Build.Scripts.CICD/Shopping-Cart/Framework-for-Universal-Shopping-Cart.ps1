#-----------------------------------------------------------------------
# <copyright file="Framework-for-Universal-Shopping-Cart.ps1" company="Genesys Source">
...
# ***
Copy-SourceCode -Path $BuildFull -RepoName $RepoName -ProductName $ProductName -SubFolder $SubFolder -SolutionFolder $SolutionFolder -Snk GenesysFramework.snk
