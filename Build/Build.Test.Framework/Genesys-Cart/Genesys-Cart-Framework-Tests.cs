//-----------------------------------------------------------------------
// <copyright file="Genesys_Cart_Framework_Tests.cs" company="Genesys Source">
...
{
    [TestClass()]
    public class Genesys_Cart_Framework_Tests
    {
        [TestMethod()]
        public async Task Genesys_Cart_Framework_Mvc()
        {
        ...
        [TestMethod()]
        public async Task Genesys_Cart_Framework_WebApi()
        {
            var configuration = ConfigurationManagerSafeTests.ConfigurationManagerSafeConstruct();
            var dataOut = TypeExtension.DefaultString;
        ...
        [TestMethod()]
        public async Task Genesys_Cart_Framework_Wpf()
        {
            var configuration = ConfigurationManagerSafeTests.ConfigurationManagerSafeConstruct();
            var dataOut = TypeExtension.DefaultString;
        ...
        [TestMethod()]
        public async Task Genesys_Cart_Framework_Universal()
        {
            var configuration = ConfigurationManagerSafeTests.ConfigurationManagerSafeConstruct();
            var dataOut = TypeExtension.DefaultString;
